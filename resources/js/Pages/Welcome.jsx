    ...
    return (
        <>
            ...
            <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                ...
                />
                <div className="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#28573a] selection:text-white">
                            ...
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                >
                                    ...
                                    <div className="relative flex items-center gap-6 lg:items-end">
                                        ...
                                        <svg
                                            className="size-6 shrink-0 stroke-[#11FF20]"
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
                                            stroke-width="1.5"
                                ...
                                <a
                                    ...
                                    className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#ff7068]"
                                >
                                    <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                        <svg
                                            className="size-5 sm:size-6"
                                    ...
                                    <svg
                                        className="size-6 shrink-0 self-center stroke-[#b7c7e9]"
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke-width="1.5"
