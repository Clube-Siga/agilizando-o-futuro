        ...
        <section id="newsletter" className={newsletterClass}>
                <Content contentClass={"py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6"}>
                    <Content contentClass={"mx-auto max-w-screen-md sm:text-center"}>
                        ...
                        <Text textClass={"mx-auto mb-8 max-w-2xl font-light text-gray-500 md:mb-12 sm:text-xl dark:text-gray-400"} textContent={"Stay up to date with the roadmap progress, announcements and exclusive discounts feel free to sign up with your email."}/>
                        <form action="#">
                            ...
                            <Content contentClass={"mx-auto max-w-screen-sm text-sm text-left text-gray-500 newsletter-form-footer dark:text-gray-300"}>
