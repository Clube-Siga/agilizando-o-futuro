            ...
            <section id="cta" className={ctaClass}>
                <Row rowClass={"gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6"}>
                    <div className="mt-4 md:mt-0">
                        <Title titleClass={"mb-4 text-4xl tracking-tight font-extrabold text-support dark:text-defaultW"} titleContent={"Let's create more tools and ideas that brings us together."}/>
                        <Text textClass={"mb-3 font-light text-support md:text-lg dark:text-defaultW"} textContent={"Flowbite helps you connect with friends and communities of people who share your interests. Connecting with your friends and family as well as discovering new ones is easy with features like Groups."}/>
