            ...
            <section id="cta" className={ctaClass}>
                <Row rowClass={"gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6"}>
                    <div className="mt-4 md:mt-0">
                        ...
                        <Text textClass={"font-body mb-3 font-light text-defaultW md:text-lg dark:text-defaultW"} textContent={"Para fazer uma doação é simples basta utilizar nossa chave Pix."}/>
