        ...
        <section className={heroClass}>
            <Row rowClass={"flex justify-center w-full px-4 py-8 mt-12 mx-auto gap-4 sm:flex-col sm:items-center md:flex-row md:space-around md:min-w-screen-md lg:gap-8 xl:gap-0 lg:py-16"}>
                <div className="flex justify-center w-full mr-auto flex-1 place-self-center sm:flex-col  sm:items-center md:space-around lg:col-span-7">
                    ...
                    <Button buttonClass={"inline-flex items-center justify-center px-1 ml-2 mr-1 text-sm font-small text-center text-defaultW rounded-lg bg-support hover:border hover:border-support hover:text-support hover:bg-defaultW focus:ring-4 focus:ring-primary dark:focus:ring-secondary sm:px-5 sm:py-3 sm:mr-3 md:text-lg"} path={"#cta"} title={"Comece aqui"} />
                </div>
