...
export default function Hero({heroClass}){
    return (
        <section className={heroClass}>
            <Row rowClass={"flex sm:flex-col justify-center w-full px-4 py-8 mt-12 mx-auto gap-4 sm:items-center md:flex-row md:space-around md:min-w-screen-md lg:gap-8 xl:gap-0 lg:py-16"}>
                <div className="flex sm:flex-col  sm:items-center md:space-around justify-center w-full mr-auto flex-1 place-self-center lg:col-span-7">
