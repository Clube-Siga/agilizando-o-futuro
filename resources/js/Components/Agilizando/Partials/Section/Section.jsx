    ...
    return(<>
        <section className={sectionClass}>
                <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                    <Row rowClass={"font-light text-gray-500 sm:text-lg dark:text-gray-400"}>
                        <Title titleClass={"mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white"} titleContent={"We didn't reinvent the wheel"}/>
