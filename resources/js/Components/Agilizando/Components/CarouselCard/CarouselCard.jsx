...
export default function CarouselCard({altText, buttonPath, buttonTitle, contentText, id, imgPath, titleClass, titleContent}){
    return (
        <>
            <div id={id} className="my-1 mx-auto flex flex-col items-center justify-center w-9/12  bg-primary rounded-2xl shadow sm:grid sm:grid-cols-2 dark:bg-secondary">
